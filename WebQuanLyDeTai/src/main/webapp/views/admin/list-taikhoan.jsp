				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Quản lý Tài Khoản
							</div>
							<div class="tools">
											...
											<div class="col-md-9">
												<form action="#" method="post" enctype="multipart/form-data">
													...
													<div class="form-group" hidden="hidden">
														<label for="id">Mã tài khoản:</label> <input
															type="text" name="id"
															value="${taikhoan.id}" id="id"
													...
													<div class="form-group">
														<label for="password">Mật khẩu:</label> <input type="text"
															...
															value="${taikhoan.password}" id="password" />
													</div>
													<div class="form-group">
														<label for="phanquyen">Quyền:
														 <div> 0. Admin  </div>
														<div>1. Trưởng bộ môn</div> 
														  <div>2. Giảng viên </div>
														  <div>3. Sinh viên </div>
												
														</label> <input type="text"
															class="form-control" name="phanquyen" id="phanquyen"
