...
@MultipartConfig
@WebServlet(urlPatterns = { "/giangvien-hoidong", "/giangvien-hoidong/create", "/giangvien-hoidong/update",
		"/giangvien-hoidong/edit", "/giangvien-hoidong/delete", "/giangvien-hoidong/reset" })
public class HoiDongController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (url.contains("create")) {
			request.getRequestDispatcher("/views/giangvien/hoidong/add.jsp").forward(request, response);
